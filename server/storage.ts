...
export interface IStorage {
  ...
  markEmailAsSentIfNotSent(id: string, emailField: 'day2EmailSent' | 'day3EmailSent' | 'day4EmailSent' | 'day5EmailSent' | 'day6EmailSent' | 'day8EmailSent' | 'day9EmailSent' | 'day10EmailSent'): Promise<boolean>;
...
export class PostgreSQLStorage implements IStorage {
  ...
  async markEmailAsSentIfNotSent(id: string, emailField: 'day2EmailSent' | 'day3EmailSent' | 'day4EmailSent' | 'day5EmailSent' | 'day6EmailSent' | 'day8EmailSent' | 'day9EmailSent' | 'day10EmailSent'): Promise<boolean> {
