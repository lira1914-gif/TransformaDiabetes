  ...
  return (
    <>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(250,248,244,0.95) 0%, rgba(238,235,225,0.9) 100%)",
        }}
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
                        ...
                        <Button
                          ...
                          onMouseEnter={(e) => {
                            e.currentTarget.style.boxShadow =
                              "0 8px 24px rgba(161, 92, 56, 0.35)";
                          }}
                          onMouseLeave={(e) => {
                            e.currentTarget.style.boxShadow =
                              "0 4px 12px rgba(161, 92, 56, 0.2)";
                          }}
                        >
                          {buttonText}
                        </Button>
              ...
              {/* Cita inspiradora */}
              <p className="text-base italic" style={{ color: "#777777" }}>
                "{finalQuote}"
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgba(85,107,47,0.05) 0%, rgba(161,92,56,0.05) 100%)",
                  }}
                />
              </div>
            </motion.div>
            ...
            <div onTouchStart={handleMobileTouch}>
              <Link href="/cuestionario">
                <Button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow =
                      "0 8px 24px rgba(183, 73, 47, 0.35)";
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.boxShadow =
                      "0 4px 12px rgba(183, 73, 47, 0.2)";
                  }}
                >
